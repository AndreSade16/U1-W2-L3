...
console.log("Blue Eye Color:", eyeColor.blue);
...
console.log("Updated robots' genders", starWarsCharacters);
...
console.log("charactersNames.length pre operazione: ", charactersNames.length);

const femaleCharactersNames = [];
for (let i = 0; i < femaleCharacters.length; i++) {
  femaleCharactersNames.push(femaleCharacters[i].name);
}

for (let i = 0; i < charactersNames.length; i++) {
  if (femaleCharactersNames.includes(charactersNames[i])) {
    charactersNames.splice(i, 1);
  }
}

console.log("charactersNames.length post operazione: ", charactersNames.length);
